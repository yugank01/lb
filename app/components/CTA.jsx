...
const CTA = () => {
  ...
  <div class="container px-5 py-16 mx-auto flex flex-wrap items-center">
    <div class="lg:w-1/2 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      ...
      KNOW YOUR <span className='text-yellow-500'>LEGAL RIGHTS</span> TODAY        </h1>
      <p class="leading-relaxed mt-4">
      We offer genuine legal advise to your problems & assist in connecting you with expert legal professionals.

</p>
    </div>
    <div class="lg:w-[45%] md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      <h2 class="text-gray-900 text-lg font-medium title-font mb-5">For Queries</h2>
      ...
      <p class="text-xs text-gray-500 mt-3">Drop your query now.</p>
    </div>
  </div>
</section>
    </div>
